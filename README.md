...
[Areas](#Areas) | List with different elements (see at [ExtraTiles](#extratiles)) | Areas in that the Walnut is obtainable
...
[Conditions](#conditions) | string | a [GameStateQuery]([https://stardewvalleywiki.com/Modding:Mail_data#Mail_flags](https://stardewvalleywiki.com/Modding:Game_state_queries) after that the Walnut becomes obtainable, for example after reading a [Secret Note](#conditions)
